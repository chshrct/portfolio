      ...
      <div className={`${cs.container} ${s.resumeContainer}`}>
        ...
        <div className={s.resume}>
          <p>
            ...
            studying frontend development, both independently and in specialized courses.
            During this time I learned how to create SPA applications using React / Redux
            / TypeScript and I keep improving my skills every day.
          </p>
